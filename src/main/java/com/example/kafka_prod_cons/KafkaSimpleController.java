...
public class KafkaSimpleController {
    ...
    public void post(@RequestBody SimpleModel simpleModel){
        ...
        //automatically converted by spring using jackson converter to convert json format to atcual pojo
        //then use google json to convert to stringified version on json
    ...
    //this gets stringigy version of json then converted back to pojo
